...
| `01_translate/` | one snapshot; `identity.md`, `rules.md`, the reference file each step names | one file in `01_translate/00_tickets/` | `Unmapped`, and every `not in source` row |
