...
| --- | --- | --- | --- |
| change | Added `format:` labels to all date and date-time strings | unnumbered | - Added `format:` labels to all date and date-time strings |
| affected_surface | not in source |  |  |
| breaking | not in source |  |  |
| entry_date | 2020-09-14 | unnumbered | ### 2020-09-14_1.20.6 |
...
| field | value | line | quote |
| --- | --- | --- | --- |
| change | Fix missing title attributes | unnumbered | - Fix missing title attributes |
| affected_surface | not in source |  |  |
| breaking | not in source |  |  |
| entry_date | 2020-09-14 | unnumbered | ### 2020-09-14_1.20.6 |
| effective_date | not in source |  |  |
...
| field | value | line | quote |
| --- | --- | --- | --- |
| change | Converted some strings to enums | unnumbered | - Converted some strings to enums |
| affected_surface | not in source |  |  |
| breaking | not in source |  |  |
| entry_date | 2020-09-14 | unnumbered | ### 2020-09-14_1.20.6 |
| effective_date | not in source |  |  |
