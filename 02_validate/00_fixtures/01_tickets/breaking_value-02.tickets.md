snapshot: terms-01.txt
sha256: 08318efc8358ec835474c515986021777c7d0ffd4b74b4500bf3d33868478ba0
...
| --- | --- | --- | --- |
| change | Added `format:` labels to all date and date-time strings | 2 | - Added `format:` labels to all date and date-time strings; this is a non-breaking change |
| affected_surface | not in source |  |  |
| breaking | yes | 2 | - Added `format:` labels to all date and date-time strings; this is a non-breaking change |
...
| source | https://raw.githubusercontent.com/plaid/plaid-openapi/84a303ae4a48816951233ba0db0ce24c7e633c9d/CHANGELOG.md terms-01.txt | 2 |  |

## Ticket 2

| field | value | line | quote |
| --- | --- | --- | --- |
| change | Fix missing title attributes | 3 | - Fix missing title attributes: a breaking change for readers, non-breaking for writers |
| affected_surface | not in source |  |  |
...
| sunset_date | not in source |  |  |
| required_action | not in source |  |  |
| source | https://raw.githubusercontent.com/plaid/plaid-openapi/84a303ae4a48816951233ba0db0ce24c7e633c9d/CHANGELOG.md terms-01.txt | 3 |  |

## Ticket 3

| field | value | line | quote |
| --- | --- | --- | --- |
| change | Converted some strings to enums | 4 | - Converted some strings to enums; the old form will stop working in 30 days |
| affected_surface | not in source |  |  |
| breaking | not in source |  |  |
| entry_date | 2020-09-14 | 1 | ### 2020-09-14_1.20.6 |
| effective_date | not in source |  |  |
| sunset_date | not in source |  |  |
| required_action | not in source |  |  |
| source | https://raw.githubusercontent.com/plaid/plaid-openapi/84a303ae4a48816951233ba0db0ce24c7e633c9d/CHANGELOG.md terms-01.txt | 4 |  |
